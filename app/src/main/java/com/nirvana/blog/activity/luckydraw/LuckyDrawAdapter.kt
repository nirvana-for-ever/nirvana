...
import com.nirvana.blog.activity.luckydraw.GameActivity.Companion.iconArray
import com.nirvana.blog.activity.luckydraw.GameActivity.Companion.nameArray

class LuckyDrawAdapter(var onClick: LuckyDrawView.DrawClickListener) : RecyclerView.Adapter<LuckyDrawAdapter.LuckyDrawItem>() {

    private var posMap = mapOf<Int, Int>(0 to 0, 1 to 1, 2 to 2, 3 to 7, 4 to 8, 5 to 3, 6 to 6, 7 to 5, 8 to 4)
    ...
    class LuckyDrawItem(itemView: View, var onClick: LuckyDrawView.DrawClickListener) :
        ...
        fun init(fakePos: Int?, selectPos: Int) {
            if (fakePos == 8) {
                ...
                tvName.setText(nameArray[fakePos])
            }
        }
